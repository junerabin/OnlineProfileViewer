            ...
            <div class="row">
                <div class="col-md-8">
                    <form action="#" class="form-inline">
                        <input type="text" class="form-control p80" placeholder="Type to search..." title="Please type the name of the candidate or browse all of them" required>
                       <button type="submit" class="btn btn-primary p20"> Search</button>
                    </form>
                </div>
                <div class="col-md-4 text-center"> 
                    <a href="#" class="btn btn-outline-primary btn-block">or Browse all</a>
                </div>
            </div>
